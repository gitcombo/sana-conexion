...
,p_last_upd_yyyymmddhh24miss=>'20200720072228'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(74695152149844514)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(74696059519844514)
,p_name=>'Page Performance'
...
,p_owner=>'SANA'
,p_internal_uid=>54153590824414551
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74696085348844515)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74696513598844515)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74696934034844516)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74697277168844516)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74697674436844517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74698147185844518)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74698529129844518)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74698881892844519)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74699355633844520)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74699696813844520)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74700090787844521)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74700554372844522)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74700937608844522)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74701328803844523)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(74702046038844524)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'541596'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PAGE:PAGE_NAME:MEDIAN_ELAPSED:WEIGHTED_PERFORMANCE:ERRORS:DISTINCT_USERS:APPLICATION_SESSIONS:PAGE_VIEWS'
,p_sort_column_1=>'PAGE_VIEWS'
,p_sort_direction_1=>'DESC'
,p_sort_column_2=>'WEIGHTED_PERFORMANCE'
,p_sort_direction_2=>'DESC'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(74695236512844514)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(74702868733844524)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(74695152149844514)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74695017913844514)
,p_name=>'P10033_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(74695236512844514)
,p_item_default=>'900'
,p_prompt=>'Timeframe'
,p_source=>'900'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74695288227844514)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74704202697844526)
,p_event_id=>wwv_flow_api.id(74695288227844514)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(74695152149844514)
);
